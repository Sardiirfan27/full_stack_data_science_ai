...
--  Filter data based on the last update time
-- ===============================================
WHERE 
    -- 1. Check if the customer data was updated
    c.last_updated > '2025-10-15 00:00:00'-- '{last_run_timestamp}'
    -- OR 2. Check if the contract data was updated
    OR con.last_updated > '2025-10-15 00:00:00'--'{last_run_timestamp}'
    -- NOTE: Transactions are not explicitly filtered here as the join/aggregate
    -- recalculates TotalCharges for the *Customer* or *Contract* that was updated.
GROUP BY 
